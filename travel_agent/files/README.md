...
An **Agentic AI** system that autonomously plans complete travel itineraries using LangChain, Google Gemini, and real-time weather data.
...
│   ├── weather_tool.py ← Calls Open-Meteo API (free, no key)
...
### 5. Enter your Gemini API key in the sidebar and start planning!
...
Agent THINKS: "I need flight info first"
    ↓
Agent CALLS: search_flights("from:Delhi to:Goa")
    ↓
...
Uses **Google Gemini 2.5 Flash** via LangChain + LangGraph.
